                ...
                function highlightNav(navName) {
                    ...
                    switch(navName) {
                        ...
                        case 'nygl':
                            ...
                            this.str = '<li class="active nygl-offset"><a class="jgfx-subnav" data-subshow="nygl-jgfx" href="/user/jgfx">结构分析</a></li><li class=""><a class="hnfx-subnav" data-subshow="nygl-hnfx" href="/user/hnfx">耗能分析</a></li><li class=""><a class="gnfx-subnav" data-subshow="nygl-gnfx" href="/user/gnfx">供能分析</a></li><li><a class="zbfx-subnav" data-subshow="nygl-zbfx" href="/user/zbfx">指标分析</a></li><li><a class="tbhb-subnav" data-subshow="nygl-tbhb" href="/user/tbhb">同比环比</a></li><li><a class="bb-subnav" data-subshow="nygl-bb" href="/user/bb">运行报表</a></li>'; 
                            break;
                        //case 'pgzd':
