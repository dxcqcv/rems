                ...
                function highlightNav(navName) {
                    ...
                    switch(navName) {
                        ...
                        //case 'pgzdzj':
                            ...
                            //break;
                        case 'pzym':
                            this.str = '<li class="active"><a class="lsxgl-subnav" data-subshow="pzym-lsxgl" href="/user/lsxgl">类属性管理</a></li><li class=""><a class="bzlgl-subnav" data-subshow="pzym-bzlgl" href="/user/bzlgl">标准类管理</a></li><li class=""><a class="sbssgl-subnav" data-subshow="pzym-sbssgl" href="/user/sbssgl">设备设施管理</a></li><li class=""><a class="xmxxgl-subnav" data-subshow="pzym-xmxxgl" href="/user/xmxxgl">项目信息管理</a></li><li class=""><a class="gysxpz-subnav" data-subshow="pzym-gysxpz" href="/user/gysxpz">工艺属性配置</a></li><li class=""><a class="zdybbpz-subnav" data-subshow="pzym-zdybbpz" href="/user/zdybbpz">自定义报表配置</a></li><li class=""><a class="mksjpz-subnav" data-subshow="pzym-mksjpz" href="/user/mksjpz">模块数据配置</a></li><li class=""><a class="rhpz-subnav" data-subshow="pzym-rhpz" href="/user/rhpz">融合配置</a></li>'
                            break;
                        case 'xtgl':
