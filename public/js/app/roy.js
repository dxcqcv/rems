        ...
        PageStart.prototype = {
            ...
            nav: function() {
                ...
                function highlightNav(navName) {
                    ...
                    switch(navName) {
                        case 'ycjc': 
                            this.str = '<li class="active"><a class="gyjc-subnav" data-subshow="ycjc-gyjc" href="/user/gyjc">运行监测</a></li><li><a class="nxjc-subnav" data-subshow="ycjc-nxjc" href="/user/nxjc">能效监测</a></li><li><a class="sjjc-subnav" data-subshow="ycjc-sjjc" href="/user/sjjc">数据监测</a></li>'; 
                            break;
                        case 'nygl':
