                ...
                function highlightNav(navName) {
                    ...
                    switch(navName) {
                        ...
                        case 'nygl':
                            ...
                            this.str = '<li class="active nygl-offset"><a class="jgfx-subnav" data-subshow="nygl-jgfx" href="/user/jgfx">结构分析</a></li><li class=""><a class="hnfx-subnav" data-subshow="nygl-hnfx" href="/user/hnfx">耗能分析</a></li><li class=""><a class="gnfx-subnav" data-subshow="nygl-gnfx" href="/user/gnfx">供能分析</a></li><li><a class="zbfx-subnav" data-subshow="nygl-zbfx" href="/user/zbfx">指标分析</a></li><li><a class="mkfx-subnav" data-subshow="nygl-mkfx" href="/user/mkfx">模块分析</a></li><li><a class="jzfx-subnav" data-subshow="nygl-jzfx" href="/user/jzfx">机组分析</a></li><li><a class="tbhb-subnav" data-subshow="nygl-tbhb" href="/user/tbhb">同比环比</a></li><li><a class="bb-subnav" data-subshow="nygl-bb" href="/user/bb">运行报表</a></li>'; 
                            break;
                        //case 'pgzd':
                        ...
                        //case 'pgzdzj':
                            ...
                            //break;
                        case 'pzym':
                            this.str = '<li class="active"><a class="gysxpz-subnav" data-subshow="pzym-gysxpz" href="/user/gysxpz">工艺属性配置</a></li><li class=""><a class="zdybbpz-subnav" data-subshow="pzym-zdybbpz" href="/user/zdybbpz">自定义报表配置</a></li><li class=""><a class="mksjpz-subnav" data-subshow="pzym-mksjpz" href="/user/mksjpz">模块数据配置</a></li><li class=""><a class="rhpz-subnav" data-subshow="pzym-rhpz" href="/user/rhpz">融合配置</a></li><li class=""><a class="tygjpz-subnav" data-subshow="pzym-tygjpz" href="/user/tygjpz">通用工具配置</a></li>'
                            break;
                        case 'xtgl':
                            this.str = '<li class="active"><a class="yhgl-subnav" data-subshow="xtgl-yhgl" href="/user/yhgl">用户管理</a></li><li class=""><a class="sfgl-subnav" data-subshow="xtgl-sfgl" href="/user/sfgl">身份管理</a></li><li class=""><a class="qxgl-subnav" data-subshow="xtgl-qxgl" href="/user/qxgl">权限管理</a></li><li class=""><a class="rzgl-subnav" data-subshow="xtgl-rzgl" href="/user/rzgl">日志管理</a></li><li class=""><a class="lsxgl-subnav" data-subshow="xtgl-lsxgl" href="/user/lsxgl">类属性管理</a></li><li class=""><a class="bzlgl-subnav" data-subshow="xtgl-bzlgl" href="/user/bzlgl">标准类管理</a></li><li class=""><a class="sbssgl-subnav" data-subshow="xtgl-sbssgl" href="/user/sbssgl">设备设施管理</a></li><li class=""><a class="xmxxgl-subnav" data-subshow="xtgl-xmxxgl" href="/user/xmxxgl">项目信息管理</a></li>'
                            break;
                        default:
                    }
