                ...
                function highlightNav(navName) {
                    ...
                    switch(navName) {
                        ...
                        case 'pgzdzj':
                            ...
                            break;
                        case 'pzym':
                            this.str = '<li class="active"><a class="lsxgl-subnav" data-subshow="pzym-lsxgl" href="/user/lsxgl">类属性管理</a></li><li class=""><a class="bzlgl-subnav" data-subshow="pzym-bzlgl" href="/user/bzlgl">标准类管理</a></li><li class=""><a class="qxgl-subnav" data-subshow="pzym-qxgl" href="/user/qxgl">权限管理</a></li><li class=""><a class="sbssgl-subnav" data-subshow="pzym-sbssgl" href="/user/sbssgl">设备设施管理</a></li><li class=""><a class="rzgl-subnav" data-subshow="pzym-rzgl" href="/user/rzgl">日志管理</a></li><li class=""><a class="yhgl-subnav" data-subshow="pzym-yhgl" href="/user/yhgl">用户管理</a></li><li class=""><a class="sfgl-subnav" data-subshow="pzym-sfgl" href="/user/sfgl">身份管理</a></li><li class=""><a class="xmxxgl-subnav" data-subshow="pzym-xmxxgl" href="/user/xmxxgl">项目信息管理</a></li><li class=""><a class="gysxpz-subnav" data-subshow="pzym-gysxpz" href="/user/gysxpz">工艺属性配置</a></li>'
                            break;
                        default:
                    }
