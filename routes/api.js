...
router.get('/effiCheck/sysindex.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/sysindex.json', form: {userKey:req.session.user.token, projectid:req.query.projectid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/effiCheck/weatherInfo.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/weatherInfo.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/effiCheck/weatherInfoNow.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/weatherInfoNow.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/effiCheck/energySourceValue.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/energySourceValue.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/effiCheck/energySourceType.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/energySourceType.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/effiCheck/energySourceChart.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/effiCheck/energySourceChart.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/projectmanagement/tree.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/projectmanagement/tree.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/project/baseinfo/cop.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/project/baseinfo/cop.json', form: {userKey:req.session.user.token, projectid:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/craftProperty/listLeft.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/craftProperty/listLeft.json', form: {userKey:req.session.user.token, project:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/clzMng/list.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/clzMng/list.json', form: {userKey:req.session.user.token, project:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/clzpropMng/list.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/clzpropMng/list.json', form: {userKey:req.session.user.token, project:req.query.projectid, pageid:req.query.pageid,userid:req.query.userid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/userInfo/list.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/userInfo/list.json', form: {userKey:req.session.user.token, project:req.query.projectid, pageid:req.query.pageid}}, function(error,response,body){
	    	res.send(body);	
	})
});
...
router.get('/logInfo/list.json', function(req, res, next) {
	request.post({url:'http://10.20.1.3:8080/rems/logInfo/list.json', form: {userKey:req.session.user.token,  page:req.query.page}}, function(error,response,body){
	    	res.send(body);	
	})
});
